...
const skills = {
    ...
    bite_1:             {name: 'bite I',            target: 'enemy', type: 'damage', attribute: 'agi', chance: 50,  power: 25,   status: 'bleed',  statusChance: 30,   critChance: 10},
    ...
    eviscerate_1:       {name: 'eviscerate I',      target: 'enemy', type: 'damage', attribute: 'agi', chance: 20,  power: 30,   status: 'bleed',  statusChance: 50,   critChance: 5},
    ...
    tusk_attack_1:      {name: 'tusk attack I',     target: 'enemy', type: 'damage', attribute: 'str', chance: 40,  power: 20,   status: 'bleed',  statusChance: 30,   critChance: 5},
