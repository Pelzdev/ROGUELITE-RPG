...
export const wiki = {
    ...
    enemies: {
        mouse: {
            ...
            hpMax: 15, 
            hpLeft: 15,
            totalMods: {dmg: 3, def: 3, str: 1, agi: 7, int: 1, chr: 1, lck: 3},
            skills: ['attack'], 
            status: '',
        ...
        forest_gecko: {
            ...
            hpMax: 15, 
            hpLeft: 15,
            totalMods: {dmg: 4, def: 3, end: 1, str: 1, agi: 6, dex: 1, int: 1, chr: 1, lck: 1},
            skills: ['attack'],
            status: '',
        ...
        toxic_frog: {
            ...
            hpMax: 25, 
            hpLeft: 25,
            totalMods: {dmg: 3, def: 3, end: 2, str: 2, agi: 7, dex: 1, int: 3, chr: 1, lck: 1},
            skills: ['attack'],
            status: '',
        ...
        mouse_assassin: {
            ...
            hpMax: 30, 
            hpLeft: 30,
            totalMods: {dmg: 5, def: 3, end: 2, str: 2, agi: 8, dex: 3, int: 3, chr: 1, lck: 3},
            skills: ['eviscerate_1'], 
            status: '',
